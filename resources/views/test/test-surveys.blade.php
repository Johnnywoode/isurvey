...
<body style="background: #e5e5e5;">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="http://localhost:8000/test/surveys">Surveys</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="http://localhost:8000/test/users">Users</a>
          </li>
        </ul>
  ...
  <div class="d-flex justify-content-between p-4">
    <span class="text-uppercase">Surveys</span>
  ...
  <div class="container">
    ...
    @foreach ($data as $survey)
      <div class="card p-4 col-md-4 mt-4">
          {{ $survey }}
        <div class="row">
          <a href="http://localhost:8000/test/surveys/{{$survey->id}}" class="btn btn-info">Take Survey</a>
        </div>
      </div>
    @endforeach
